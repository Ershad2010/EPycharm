...
user = 'Ahmad'  # the user in which the auth. token is given
website_url = 'https://bestjobinuae.com' #Your website url
pythonapp = 'W444 GVr5 ghQA TFn1 ooSd ATBK'  # paste here your auth. token
