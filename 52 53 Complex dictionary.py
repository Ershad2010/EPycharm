...
for user in users:
  ...
  location = user.get("address").get("geo").get("lat", "lng")
  company = user.get("company").get("name")
  phone = user.get("phone")
  sentence = f'The username of {name} is {username}. ' \
           f'His email address is {email}. ' \
           f'He lives in {street}, {suite}, {city}.' \
           f'The exact location is {location}. His phone no is {phone}. ' \
